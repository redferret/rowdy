 ...
 * @author Richard
 */
public class FactorMul extends BaseNode {
    
  public FactorMul(Symbol symbol, int lineNumber) {
  ...
  public Object execute(Object leftValue) {
    ...
    return Calculator.calculate((Value) leftValue, rightValue, tailNode, Calculator.Operation.MULTIPLY);
  }
