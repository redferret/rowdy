...
public class Function {
	...
	private String name;
	private Hashtable<String, Value> symbolTable;
	
	public Function(String name, Hashtable<String, Value> params){
		this.name = name;
    ...
    /**
     * Frees up the memory used by this function. Deletes all
     * the parameters and local variables stored for this function
     * and then nullifies the function's symbol table.
     */
    public void free(){
    	symbolTable.clear();
    	symbolTable = null;
